...
public class EmailController {
	...
	@PostMapping("/{type}")
	public ResponseEntity<?> sendNotification(@PathVariable String type, @RequestParam String recipient,
			@RequestParam String message, @RequestParam String subject) {
		// http://localhost:6060/email-service/notify/email?recipient=acbcloud@gmail.com&message=Hello&subject=registration
		// success
